#!/usr/bin/env bash
# Component Setup pre-workloads for the Cache (ADR-0055 / #221 / #222 / #224 / #225 / #232).
# Standing ensure then Declaration converge (gather/create/publish; stop unpublish+disable).
