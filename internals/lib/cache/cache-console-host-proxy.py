#!/usr/bin/env python3
"""Host-local TCP proxy into cache-valkey netns (ADR-0055 / #226).
...
Valkey container network namespace, and dials 127.0.0.1:6379 there.

Usage: cache-console-host-proxy.py <netns-pid> <listen-port> <pidfile>
"""
...
def _child(conn: socket.socket, netns_pid: str) -> None:
    try:
        ...
        upstream = socket.create_connection(("127.0.0.1", 6379))
